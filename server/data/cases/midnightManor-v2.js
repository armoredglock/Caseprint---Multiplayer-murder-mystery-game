module.exports = {
  ...
  "forensics": {
    ...
    "externalExam": "A minor bump on the head (blunt force trauma), but insufficient to cause death. The victim was already dead when he fell and struck his head on the desk.",
    "internalExam": "Otherwise healthy.",
    "toxicology": [
      {
        "substance": "Aconite (Wolfsbane)",
        "result": "Positive",
        "level": "Lethal",
        "reference": "Negative"
      }
    ...
    "dna": "None found.",
    "causeOfDeath": "Cardiac Arrest secondary to Aconite Poisoning.",
  ...
  "physicalEvidence": [
    {
      "tagNumber": "EV-001",
      "description": "Small glass vial",
      "locationFound": "In the fireplace ashes",
      "photo": "/cases/ev-vial.jpg",
      "significance": "Contains trace amounts of Aconite.",
      "chainOfCustody": [
        {
          "officer": "Crime Scene Tech",
          "date": "2024-11-01 01:00",
          "action": "Recovered"
        }
      ]
    },
  ...
  "timeline": [
    {
      "time": "22:00",
      "event": "Lord Blackwood announces his intention to change the will.",
      "linkedEvidence": [],
      "critical": false
    },
    {
      "time": "23:30",
      "event": "Power goes out. Beatrice slips Aconite into Lord Blackwood's tea.",
      "linkedEvidence": [],
      "critical": true
    },
    {
      "time": "23:35",
      "event": "Loud thump heard by Jeeves.",
      "linkedEvidence": [],
      "critical": true
    },
    {
      "time": "23:40",
      "event": "Jeeves unlocks the door and finds the body.",
      "linkedEvidence": [],
      "critical": true
    }
  ],
