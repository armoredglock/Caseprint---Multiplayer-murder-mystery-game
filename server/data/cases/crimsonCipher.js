module.exports = {
  ...
  victim: {
    ...
    knownAssociates: [
      { name: "Eleanor Vance", relation: "Wife", photo: "https://i.pravatar.cc/150?u=EleanorVance" }
    ]
  },
  suspects: [
    {
  ...
  forensics: {
    ...
    toxicology: [
      { substance: "Tetrodotoxin (Pufferfish Poison)", result: "Positive", level: "Lethal", reference: "Negative" }
    ],
    fingerprints: "A partial print on the victim's collar matches Victor Thorne. However, a bloody boot print matches the exact size and wear of standard issue police boots.",
  ...
  physicalEvidence: [
    {
      ...
      chainOfCustody: [{ officer: "Det. Miller", date: "2024-11-20 03:30", action: "Collected at scene" }]
    },
    {
      tagNumber: "EV-002",
      ...
      chainOfCustody: [{ officer: "CSU Tech", date: "2024-11-20 05:00", action: "Recovered" }]
    }
  ],
  timeline: [
    { time: "00:45", event: "Arthur Vance leaves the Daily Chronicle office.", linkedEvidence: [], critical: true },
    { time: "01:30", event: "Dr. Crane leaves the operating room.", linkedEvidence: [], critical: false },
    { time: "02:00", event: "Black sedan arrives at warehouse (Witness Pete).", linkedEvidence: [], critical: true },
    { time: "02:30", event: "Killer leaves the warehouse, limping.", linkedEvidence: [], critical: true },
    { time: "03:15", event: "Police arrive at the scene.", linkedEvidence: [], critical: true }
  ],
  digitalEvidence: {
    phoneRecords: [
      { from: "Arthur Vance", to: "Det. Miller", time: "00:15", duration: "02:14", type: "OUTGOING", flagged: true },
      { from: "Unknown (Burner)", to: "Arthur Vance", time: "00:30", duration: "00:45", type: "INCOMING", flagged: true }
    ],
    emails: [
      {
    ...
    cctvLogs: [
      { camera: "CAM-STREET-9", timestamp: "02:05:12", note: "[DISTORTED] A dark vehicle passes the camera, license plate unreadable.", flagged: true },
      { camera: "CAM-HOSPITAL-EXIT", timestamp: "01:32:00", note: "Dr. Crane exits the hospital, visibly agitated.", flagged: false },
      { camera: "CAM-HOSPITAL-ENTRY", timestamp: "02:47:00", note: "Dr. Crane returns, walking with a slight limp.", flagged: true }
    ],
    puzzles: [
      {
        id: "puz-002",
        title: "The Bloody Wall Cipher",
        description: "The killer left this message painted in blood on the wall. It appears to be a Hexadecimal string.",
        data: "54 68 65 20 64 6f 63 74 6f 72 20 69 73 20 69 6e 2e 20 42 75 74 20 68 65 20 69 73 20 6e 6f 74 20 74 68 65 20 6d 61 73 74 65 72 6d 69 6e 64 2e",
        format: "HEX",
        hint: "Convert from Hex to ASCII text."
      },
      {
        id: "puz-003",
    ...
    socialMedia: "",
    other: "A deep dive into Arthur's laptop revealed a hidden folder named 'Crimson'. It contains a single text file stating: 'Miller is hiding something. He knows the killer.'"
  },
  solution: {
    killer: "Eleanor Vance & Victor Thorne (Accomplice)",
    method: "Eleanor hired Victor Thorne to paralyze Arthur with Tetrodotoxin. She then performed the surgical mutilations to frame Dr. Crane, using stolen medical supplies. Dr. Crane merely went out to buy drugs, hence his limp from an unrelated fall.",
    motive: "Financial gain and silencing. Arthur discovered she was siphoning money to the Syndicate and was about to expose her."
  }
};
